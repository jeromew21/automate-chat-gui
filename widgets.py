...
class OverlayWindow(QMainWindow):
    """Example code for borderless, always-on-top window. Might not need."""
    def __init__(self):
...
class MainDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Gui Automate")
    ...
    def createTopLeftGroupBox(self):
        ...
        text1 = QLabel("Text entry coordinates") 
    ...
    def createTopRightGroupBox(self):
        ...
        defaultPushButton.clicked.connect(lambda: print("hi button"))
